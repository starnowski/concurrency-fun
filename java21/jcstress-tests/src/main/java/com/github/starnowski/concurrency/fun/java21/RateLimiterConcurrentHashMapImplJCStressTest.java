...
@State
@Description("RateLimiterConcurrentHashMapImpl is executed by two actors that are trying to accept its rate with the same input")
public class RateLimiterConcurrentHashMapImplJCStressTest {

    private static final String userAgent = "15";
    private static final String ipAddress = "0.0.0.0";
    private RateLimiter rateLimiter = new RateLimiterConcurrentHashMapImpl(Clock.systemUTC(), 1, Duration.ofSeconds(60));
